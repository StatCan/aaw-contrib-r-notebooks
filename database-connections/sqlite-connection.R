...
if (file.exists("/home/jovyan/aaw-contrib-r-notebooks/database-connections/latin_phrases.db")) {

  con <- dbConnect(RSQLite::SQLite(), "/home/jovyan/aaw-contrib-r-notebooks/database-connections/latin_phrases.db")
